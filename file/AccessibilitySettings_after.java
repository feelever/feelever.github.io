...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    private void handleToggleEnhanceNavigationBarPreferenceChange(boolean checked) {
        Settings.Secure.putInt(getContentResolver(),
                Settings.Secure.ACCESSIBILITY_ENHANCE_NAVIGATION_BAR, (checked ? 1 : 0));
        if(!checked){
            //开始发送广播
    ...
    private void initializeAllPreferences() {
        ...
        mToggleEnhanceNavigationBarPreference =
                (SwitchPreference) findPreference(TOGGLE_ENHANCE_NAVIGATION_BAR_PREFERENCE);
    ...
    private void updateSystemPreferences() {
        ...
        // Enhance navigation bar.
        final boolean enhanceNaviagtionBarEnabled = Settings.Secure.getInt(getContentResolver(),
